...
//import QtWebKit 3.0
//This is android so we will have to make this only fro perminamom apps because it is alot more code to write and alos because new objects = more support.
...
//                                    console.log("back clicked")
    ...
    Image{
        ...
        PathView{
            id:gridView
            focus: true
            property int delegateWidth : Screen.width/6.4
            property int delegateHeight : Screen.width/6.4
//            contentHeight: videosRoot.height
//            contentWidth: videosRoot.width
            width: Screen.width //videosRoot.width / 6.4
...
//                        pathItemCount: 10
                        startX: 0; startY: (gridView.height - gridView.delegateHeight)/2.0
                        PathAttribute { name: "rotation"; value: 60 }
                        PathAttribute { name: "z"; value: 1.0 }
                        PathAttribute { name: "scale"; value: 2.0 }
                        PathLine { x: gridView.width/2 - gridView.delegateHeight/2.0 - 1; y: coverFlood.startY }
                        PathAttribute { name: "rotation"; value: 60 }
                        PathAttribute { name: "z"; value: 20.0 }
                        PathAttribute { name: "scale"; value: 2.0 }
                        PathLine { x: gridView.width/2; y: coverFlood.startY }
                        ...
                        PathAttribute { name: "z"; value: 20.0 }
                        PathAttribute { name: "scale"; value: 2.0 }
                        PathLine { x: gridView.width; y: coverFlood.startY }
                        PathAttribute { name: "rotation"; value: -60 }
                        PathAttribute { name: "z"; value: 1.0 }
                        PathAttribute { name: "scale"; value: 2.0 }
        }
...
//               settings.x =  videosRoot.width - (settings.width)
//            else
