...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_DeviceInfo_t, stringdata) + ofs \
...
QT_MOC_LITERAL(3, 21, 8)
    ...
    "DeviceInfo\0attached\0\0getCable\0"
};
...
const QMetaObject DeviceInfo::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_DeviceInfo.data,
      qt_meta_data_DeviceInfo,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_DeviceInfo.stringdata))
