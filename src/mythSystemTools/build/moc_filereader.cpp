...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_FileReader_t, stringdata) + ofs \
...
QT_MOC_LITERAL(3, 21, 8)
    ...
    "FileReader\0readFile\0\0fileName\0"
};
...
void FileReader::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: { QString _r = _t->readFile((*reinterpret_cast< const QString(*)>(_a[1])));
...
const QMetaObject FileReader::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_FileReader.data,
      qt_meta_data_FileReader,  qt_static_metacall, 0, 0}
};
