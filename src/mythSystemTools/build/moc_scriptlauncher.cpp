...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_ScriptLauncher_t, stringdata) + ofs \
...
QT_MOC_LITERAL(3, 29, 11)
    ...
    "ScriptLauncher\0launchScript\0\0application\0"
};
...
void ScriptLauncher::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->launchScript((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        default: ;
        }
    }
}
...
const QMetaObject ScriptLauncher::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_ScriptLauncher.data,
      qt_meta_data_ScriptLauncher,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_ScriptLauncher.stringdata))
