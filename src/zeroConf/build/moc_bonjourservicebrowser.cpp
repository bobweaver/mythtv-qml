...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_BonjourServiceBrowser_t, stringdata) + ofs \
...
void BonjourServiceBrowser::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        BonjourServiceBrowser *_t = static_cast<BonjourServiceBrowser *>(_o);
        switch (_id) {
        ...
        {
            typedef void (BonjourServiceBrowser::*_t)(const QList<BonjourRecord> & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&BonjourServiceBrowser::currentBonjourRecordsChanged)) {
                *result = 0;
            }
        }
        {
            typedef void (BonjourServiceBrowser::*_t)(DNSServiceErrorType );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&BonjourServiceBrowser::error)) {
                *result = 1;
            }
        }
    }
...
const QMetaObject BonjourServiceBrowser::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_BonjourServiceBrowser.data,
      qt_meta_data_BonjourServiceBrowser,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_BonjourServiceBrowser.stringdata))
