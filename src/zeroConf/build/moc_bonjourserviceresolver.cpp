...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_BonjourServiceResolver_t, stringdata) + ofs \
...
QT_MOC_LITERAL(10, 134, 13)
    ...
    "cleanupResolve\0finishConnect\0"
};
...
void BonjourServiceResolver::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        BonjourServiceResolver *_t = static_cast<BonjourServiceResolver *>(_o);
        switch (_id) {
        ...
        {
            typedef void (BonjourServiceResolver::*_t)(const QHostInfo & , int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&BonjourServiceResolver::bonjourRecordResolved)) {
                *result = 0;
            }
        }
        {
            typedef void (BonjourServiceResolver::*_t)(DNSServiceErrorType );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&BonjourServiceResolver::error)) {
                *result = 1;
            }
        }
    }
...
const QMetaObject BonjourServiceResolver::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_BonjourServiceResolver.data,
      qt_meta_data_BonjourServiceResolver,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_BonjourServiceResolver.stringdata))
        return static_cast<void*>(const_cast< BonjourServiceResolver*>(this));
